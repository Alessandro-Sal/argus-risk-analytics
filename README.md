...
[![Test Suite](https://img.shields.io/badge/PyTest-811%2F811%20PASSED%20(100%25)-brightgreen)](tests/)
...
## 🚀 Institutional Desk Architecture, Methodological Info Boxes, ISDA SIMM™ v2.6, Rough Vol SVI, CDS Tranches, ALM/LDI & Bilateral XVA (v9.18.0)
...
- **Bilateral XVA & Counterparty Credit Risk Engine (`core/xva_engine.py`, `src/pages/7_🌪️_Stress_Testing.py`)**: Calcolo CVA, DVA, FVA, MVA e KVA, simulazione Monte Carlo profili di esposizione ($EE$, $PFE_{95\%}$, $PFE_{99\%}$, $ENE$, $EEPE$) e accordi di compensazione CSA bilaterali.
