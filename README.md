...
## 🚀 XVA Counterparty Risk, Heston FFT Volatility, Black-Litterman, Basel III Liquidity, Structured Products & PRIIPs/SFDR (v9.17.0)

ARGUS v9.17.0 completa la suite istituzionale con 6 motori quantitativi di livello Tier-1 per banche d'investimento, desk derivati, tesorerie e gestori patrimoniali:
...
- **Nuovi Endpoint REST Headless v9.17.0 (`api/main.py`)**: `/api/v1/risk/xva`, `/api/v1/pricing/heston`, `/api/v1/optimize/black-litterman`, `/api/v1/risk/basel-liquidity`, `/api/v1/pricing/structured-products`, `/api/v1/regulatory/priips-sfdr`.
