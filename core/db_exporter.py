...
def save_snapshot_to_db(results: dict, engine, portfolio_id: int, run_id: str, run_name: str = None):
    ...
    with engine.begin() as conn:
        conn.execute(sqlt(insert_snapshot), {
            ...
            "rname":  run_name,
            "pid":    portfolio_id,
            "val":    _safe_float(ret.get("portfolio_value")),
            "pnl":    _safe_float(ret.get("total_pnl")),
            ...
            "covid":  _safe_float(covid_loss),
            "lehman": _safe_float(lehman_loss),
            "rates":  _safe_float(rates_loss),
        ...
        for _, r in pos.iterrows():
            ...
            conn.execute(sqlt(insert_pos), {
                ...
                "qty":  _safe_float(r.get("qty_net")),
                "avgc": _safe_float(r.get("avg_cost")),
                "lp":   _safe_float(r.get("last_price")),
                "cval": _safe_float(r.get("current_value")),
                "upnl": _safe_float(r.get("unrealized_pnl")),
                ...
                "target": _safe_float(r.get("target_mean_price")),
