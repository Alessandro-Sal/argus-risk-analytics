...
def _generate_reportlab_executive_factsheet(portfolio_name: str, risk_data: dict, base_currency: str = "EUR") -> bytes:
    ...
    scenarios_ref = [
        (
            ...
            "Mar 2000 - Ott 2002",
            stress.get("Dot-Com Crash (Mar 2000 - Ott 2002)", {}).get("portfolio_loss_pct", -48.2),
        ),
        (
            "Lehman Brothers Collapse",
            "Sep 2008 - Nov 2008",
            stress.get("Lehman Brothers (Sep-Nov 2008)", {}).get("portfolio_loss_pct", -35.1),
        ),
        (
            "US Sovereign Downgrade",
            "Ago 2011 - Ott 2011",
            stress.get("US Downgrade Crisis (Ago 2011)", {}).get("portfolio_loss_pct", -16.5),
        ),
        (
            "COVID-19 Global Shock",
            "Feb 2020 - Mar 2020",
            stress.get("COVID-19 Crash (Feb-Mar 2020)", {}).get("portfolio_loss_pct", -22.4),
        ),
        (
            "Tech & Inflation Rate Shock",
            "Gen 2022 - Ott 2022",
            stress.get("Tech & Rate Shock (Gen-Ott 2022)", {}).get("portfolio_loss_pct", -18.2),
        ),
    ]
