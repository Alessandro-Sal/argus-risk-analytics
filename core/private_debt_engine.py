    ...
    return [
        {
            ...
            "tranches": [
                {
                    "name": "Senior Secured (Term Loan A)",
                    "notional_eur": 15000000.0,
                    "margin_euribor_bps": 450,
                    "euribor_pct": 3.25,
                    "pik_margin_bps": 0,
                    "seniority": 1,
                },
                {
                    "name": "Unitranche (Term Loan B)",
                    "notional_eur": 7000000.0,
                    "margin_euribor_bps": 650,
                    "euribor_pct": 3.25,
                    "pik_margin_bps": 150,
                    "seniority": 2,
                },
                {
                    ...
                    "notional_eur": 3000000.0,
                    "margin_euribor_bps": 850,
                    "euribor_pct": 3.25,
                    "pik_margin_bps": 300,
                    "seniority": 3,
                },
            ],
            "covenants": {"max_leverage_net_debt_ebitda": 4.20, "min_interest_coverage_ratio": 2.75, "min_dscr": 1.25},
        },
        {
            ...
            "tranches": [
                {
                    "name": "Senior Secured Green Loan",
                    "notional_eur": 30000000.0,
                    "margin_euribor_bps": 400,
                    "euribor_pct": 3.25,
                    "pik_margin_bps": 0,
                    "seniority": 1,
                },
                {
                    "name": "Junior Mezzanine Bond",
                    "notional_eur": 10000000.0,
                    "margin_euribor_bps": 750,
                    "euribor_pct": 3.25,
                    "pik_margin_bps": 200,
                    "seniority": 2,
                },
            ],
            "covenants": {"max_leverage_net_debt_ebitda": 4.50, "min_interest_coverage_ratio": 3.00, "min_dscr": 1.30},
        },
    ]


def compute_private_debt_waterfall_and_covenants(
    deal_data: Optional[Dict[str, Any]] = None, ebitda_stress_pct: float = 0.0
) -> Dict[str, Any]:
    """
    ...
    total_facility = (
        sum(t["notional_eur"] for t in tranches) if tranches else float(deal.get("total_facility_eur", 25000000.0))
    )
    ...
    cov_limits = deal.get(
        "covenants", {"max_leverage_net_debt_ebitda": 4.5, "min_interest_coverage_ratio": 2.5, "min_dscr": 1.2}
    )
    ...
    covenant_status = (
        "PASS 🟢" if not (leverage_breached or icr_breached or dscr_breached) else "BREACH 🔴 (Covenant Violato)"
    )
    ...
    return {
        ...
        "weighted_all_in_yield_pct": round(
            (total_cash_interest + total_pik_interest) / max(0.01, total_facility) * 100.0, 2
        ),
        "credit_metrics": {
