...
def render_spotlight_palette():
    ...
    with col_exec:
        ...
        if st.button(
            exec_label,
            key="btn_exec_command_go",
            use_container_width=True,
            type="primary" if parsed_cmd else "secondary",
        ):
            if parsed_cmd:
    ...
    with col_res1:
        st.markdown(
            '<div style="font-size:11.5px; font-weight:700; color:#ff9900; margin-bottom:6px; letter-spacing:0.5px;">📑 SCHEDE & MODULI ANALITICI</div>',
            unsafe_allow_html=True,
        )
        ...
        search_index = [
            # Control Room
            {
                "title": "🎛️ Control Room & Ingestione CSV",
                "page": "0_Control_Room.py",
                "tab_key": None,
                "target": None,
                "keywords": "control room upload csv degiro database ingestione parametri mysql offline cr",
            },
            # Dashboard
            {
                "title": "📈 Dashboard Generale & Copilot",
                "page": "pages/1_📈_Dashboard_Generale.py",
                "tab_key": None,
                "target": None,
                "keywords": "dashboard cagr sharpe rendimento cumulato benchmark max drawdown kpi dash",
            },
            # Live Terminal
            {
                "title": "🖥️ Live Terminal & Real-Time Market Desk",
                "page": "pages/2_🖥️_Live_Terminal.py",
                "tab_key": None,
                "target": None,
                "keywords": "terminal live quote market tape bloomberg cli desk tape live order book",
            },
            # Rischio
            {
                "title": "🔴 Rischio ➔ VaR, CVaR & Marginal VaR",
                "page": "pages/3_🔴_Analisi_Rischio.py",
                "tab_key": "risk_active_tab",
                "target": "📉 VaR, CVaR & Backtesting Kupiec",
                "keywords": "var cvar cornish fisher marginal component lvar rischio perdita risk port",
            },
            {
                "title": "🔴 Rischio ➔ Backtesting VaR & Test Kupiec",
                "page": "pages/3_🔴_Analisi_Rischio.py",
                "tab_key": "risk_active_tab",
                "target": "📉 VaR, CVaR & Backtesting Kupiec",
                "keywords": "kupiec basel backtesting violazioni var test p-value",
            },
            {
                "title": "🔴 Rischio ➔ Modello Fama-French & Carhart",
                "page": "pages/3_🔴_Analisi_Rischio.py",
                "tab_key": "risk_active_tab",
                "target": "📊 Profilo del Rischio & Fama-French",
                "keywords": "fama french carhart smb hml mom wml fattori regressione alpha beta",
            },
            {
                "title": "🔴 Rischio ➔ Limiti di Rischio & Conformità UCITS",
                "page": "pages/3_🔴_Analisi_Rischio.py",
                "tab_key": "risk_active_tab",
                "target": "📊 Profilo del Rischio & Fama-French",
                "keywords": "limiti concentrazione ucits mifid conformità breach stop loss",
            },
            {
                "title": "🔴 Rischio ➔ Rilevamento Anomalie ML (Isolation Forest)",
                "page": "pages/3_🔴_Analisi_Rischio.py",
                "tab_key": "risk_active_tab",
                "target": "🕵️‍♂️ Rilevatore Anomalie ML (Isolation Forest)",
                "keywords": "isolation forest machine learning anomalie outlier cluster ml",
            },
            # Quant
            {
                "title": "🔬 Quant ➔ Frontiera Markowitz & Rebalancing",
                "page": "pages/4_🔬_Modelli_Quantitativi.py",
                "tab_key": "quant_active_tab",
                "target": "📊 Frontiera Markowitz & Rebalancing",
                "keywords": "markowitz frontiera efficiente ledoit wolf sandbox ribilanciamento pesi sharpe rebal",
            },
            {
                "title": "🔬 Quant ➔ Hierarchical Risk Parity (HRP)",
                "page": "pages/4_🔬_Modelli_Quantitativi.py",
                "tab_key": "quant_active_tab",
                "target": "📊 Frontiera Markowitz & Rebalancing",
                "keywords": "hrp hierarchical risk parity lopez de prado clustering dendrogramma",
            },
            {
                "title": "🔬 Quant ➔ Tail Copula & Kelly Sizing",
                "page": "pages/4_🔬_Modelli_Quantitativi.py",
                "tab_key": "quant_active_tab",
                "target": "🧬 Tail Copula & Kelly Sizing",
                "keywords": "tail copula clayton gumbel kelly criterion sizing half kelly crash contagion copula",
            },
            {
                "title": "🔬 Quant ➔ Monte Carlo 10k Paths & Merton",
                "page": "pages/4_🔬_Modelli_Quantitativi.py",
                "tab_key": "quant_active_tab",
                "target": "🎲 Simulazioni Stocastiche (Monte Carlo & Merton)",
                "keywords": "monte carlo merton jump diffusion student-t cholesky simulazione stocastica mc",
            },
            {
                "title": "🔬 Quant ➔ Opzioni Black-Scholes & SABR Skew",
                "page": "pages/4_🔬_Modelli_Quantitativi.py",
                "tab_key": "quant_active_tab",
                "target": "🛡️ Hedging Tattico & Tail Risk",
                "keywords": "opzioni black scholes call put greeks delta gamma theta vega hedge vols",
            },
            {
                "title": "🔬 Quant ➔ Performance Attribution (Brinson & Carino)",
                "page": "pages/4_🔬_Modelli_Quantitativi.py",
                "tab_key": "quant_active_tab",
                "target": "🎯 Attribuzione Brinson-Fachler",
                "keywords": "brinson fachler carino menchero allocazione selezione interazione attribution attr",
            },
            {
                "title": "🔬 Quant ➔ Modelli Fattoriali (Carhart & Barra 5F)",
                "page": "pages/4_🔬_Modelli_Quantitativi.py",
                "tab_key": "quant_active_tab",
                "target": "🏛️ Modelli Fattoriali, Black-Litterman & ML",
                "keywords": "carhart barra fama french black litterman fattori regressione ml",
            },
            # Posizioni
            {
                "title": "📋 Posizioni ➔ FIFO Realized & Graveyard",
                "page": "pages/5_📋_Posizioni_e_Dettagli.py",
                "tab_key": "positions_active_tab",
                "target": "🪦 Posizioni Chiuse & Graveyard",
                "keywords": "posizioni fifo plusvalenze minusvalenze pnl book ordini titoli graveyard",
            },
            {
                "title": "📋 Posizioni ➔ Fisco Italiano TUIR Art. 67 & Step-Up",
                "page": "pages/5_📋_Posizioni_e_Dettagli.py",
                "tab_key": "positions_active_tab",
                "target": "💰 Ottimizzazione Fiscale (TUIR Art. 67)",
                "keywords": "fisco tasse tuir imposte minusvalenze capital gain 26% tax harvesting step-up tax",
            },
            {
                "title": "📋 Posizioni ➔ Calendario Dividendi & Yield",
                "page": "pages/5_📋_Posizioni_e_Dettagli.py",
                "tab_key": "positions_active_tab",
                "target": "📅 Proiezione Dividendi",
                "keywords": "dividendi stacco yield cedole proiezioni calendario div",
            },
            # Valutazione
            {
                "title": "🏛️ Valutazione ➔ DCF Monte Carlo & WACC",
                "page": "pages/6_🏛️_Valutazione_Aziendale.py",
                "tab_key": "val_segmented_tab",
                "target": "🧮 Valutazione Intrinseca DCF Monte Carlo",
                "keywords": "dcf discounted cash flow wacc capm fair value intrinseco monte carlo",
            },
            {
                "title": "🏛️ Valutazione ➔ Solvibilità Altman & Beneish",
                "page": "pages/6_🏛️_Valutazione_Aziendale.py",
                "tab_key": "val_segmented_tab",
                "target": "📊 Bilanci & Solvibilità (Altman & DuPont)",
                "keywords": "altman z score dupont bilanci solvibilita beneish m score sloan des fa",
            },
            {
                "title": "🏛️ Valutazione ➔ Consensus Analisti & Target Price",
                "page": "pages/6_🏛️_Valutazione_Aziendale.py",
                "tab_key": "val_segmented_tab",
                "target": "🏛️ Fair Value & Consensus Analisti",
                "keywords": "consensus analisti target price price target anr stime",
            },
            # Stress
            {
                "title": "🌪️ Stress Testing ➔ Matrice Scenari MSCI Barra",
                "page": "pages/7_🌪️_Stress_Testing.py",
                "tab_key": "stress_active_tab",
                "target": "⚡ Matrice Comparativa MSCI Barra",
                "keywords": "stress testing msci barra scenari storici crisi 2008 covid crollo stress",
            },
            # Analisi Temporale
            {
                "title": "📊 Analisi Temporale ➔ Storicizzazione Multi-Snapshot",
                "page": "pages/8_📊_Analisi_Temporale.py",
                "tab_key": None,
                "target": None,
                "keywords": "analisi temporale snapshot storicizzazione drawdown rolling timeline",
            },
            # Tecnica
            {
                "title": "📈 Tecnica ➔ Candlestick & Volume Profile (POC)",
                "page": "pages/9_📈_Analisi_Tecnica.py",
                "tab_key": "tech_active_subtab",
                "target": "📊 Cockpit Completo (Candlestick + Overlays + Volume Profile)",
                "keywords": "analisi tecnica candlestick volume profile poc vah val rsi macd hp tech",
            },
            # Screener
            {
                "title": "🔍 Screener ➔ Screener Opportunità (EQS)",
                "page": "pages/10_🔍_Screener_Opportunita.py",
                "tab_key": "screener_segmented_subtab",
                "target": "🔍 Screener Multi-Fattoriale & Archetipi",
                "keywords": "screener filtri opportunita momentum value growth dividendi qualita eqs",
            },
            {
                "title": "🔍 Screener ➔ Pre-Trade Impact Simulator",
                "page": "pages/10_🔍_Screener_Opportunita.py",
                "tab_key": "screener_segmented_subtab",
                "target": "🧪 Pre-Trade Portfolio Impact Simulator",
                "keywords": "pre-trade simulatore impatto nuovo acquisto asset candidato",
            },
            # BQuant
            {
                "title": "💻 BQuant ➔ Python Sandbox & Launchpad",
                "page": "pages/11_💻_BQuant_e_Launchpad.py",
                "tab_key": "bquant_active_tab",
                "target": "🐍 ARGUS BQuant Python Sandbox",
                "keywords": "bquant python console sandbox script launchpad excel rtd workspace",
            },
        ]
    ...
    with col_res2:
        st.markdown(
            '<div style="font-size:11.5px; font-weight:700; color:#ff9900; margin-bottom:6px; letter-spacing:0.5px;">💼 MNEMONICI RAPIDI & TICKER</div>',
            unsafe_allow_html=True,
        )
    ...
    with col_res3:
        st.markdown(
            '<div style="font-size:11.5px; font-weight:700; color:#ff9900; margin-bottom:6px; letter-spacing:0.5px;">⌨️ SHORTCUTS</div>',
            unsafe_allow_html=True,
        )
...
def render_wealth_spotlight_palette():
    ...
    with col_exec:
        ...
        if st.button(
            exec_label,
            key="btn_exec_wealth_command_go",
            use_container_width=True,
            type="primary" if parsed_cmd else "secondary",
        ):
            if parsed_cmd:
    ...
    with col_w1:
        st.markdown(
            '<div style="font-size:11.5px; font-weight:700; color:#10b981; margin-bottom:6px; letter-spacing:0.5px;">🏛️ MODULI &amp; STRUMENTI WEALTH</div>',
            unsafe_allow_html=True,
        )

        wealth_search_index = [
            {
                "title": "🎛️ Control Room & Ingestione Wealth",
                "page": "pages/12_🎛️_Wealth_Control_Room.py",
                "tab_key": None,
                "target": None,
                "keywords": "control room upload csv estratti conto sincronizzazione gsheets saldi conti wcr",
            },
            {
                "title": "🏛️ Patrimonio & Net Worth Consolidato",
                "page": "pages/13_🏛️_Patrimonio_e_NetWorth.py",
                "tab_key": None,
                "target": None,
                "keywords": "stato patrimoniale net worth attivo passivo liquidita investimenti salute networth nw wealth",
            },
            {
                "title": "📊 Wealth Temporal Desk (Matrici & Drawdown)",
                "page": "pages/13_🏛️_Patrimonio_e_NetWorth.py",
                "tab_key": None,
                "target": None,
                "keywords": "analisi temporale progressione storica matrice mensile underwater rolling stagionalita wtime time",
            },
            {
                "title": "💳 Cash Flow, Spese & Budgeting 50/30/20",
                "page": "pages/14_💳_Cash_Flow_e_Spese.py",
                "tab_key": None,
                "target": None,
                "keywords": "cash flow uscite entrate 50 30 20 buste envelope abbonamenti riclassificazione cashflow budget cf",
            },
            {
                "title": "⌚ Caveau Asset Fisici, Orologi & Illiquidi",
                "page": "pages/15_⌚_Asset_Illiquidi_e_Orologi.py",
                "tab_key": None,
                "target": None,
                "keywords": "caveau orologi rolex patek arte metalli oro private equity debt perizie watches illiquid pdebt",
            },
            {
                "title": "🛡️ Previdenza, Fondi Pensione & Goal SPI",
                "page": "pages/16_🛡️_Previdenza_e_Pension_Planning.py",
                "tab_key": None,
                "target": None,
                "keywords": "previdenza integrativa fondi pensione tfr merton obiettivi glide path deducibilita pension goal",
            },
            {
                "title": "🔥 Indipendenza Finanziaria, FIRE & SWR",
                "page": "pages/17_🔥_Indipendenza_Finanziaria_e_FIRE.py",
                "tab_key": None,
                "target": None,
                "keywords": "fire financial independence safe withdrawal rate 4% monte carlo sequenza rendimenti coast lean",
            },
            {
                "title": "📑 Fiscalità, Monitoraggio Estero & Quadro RW",
                "page": "pages/18_📑_Fiscalita_e_Quadro_RW.py",
                "tab_key": None,
                "target": None,
                "keywords": "fisco quadro rw ivafe mod redditi minusvalenze zainetto neo residenti cross border rw globaltax tax",
            },
            {
                "title": "🏡 Immobili, Mutui Ammortamento & Buy vs Rent",
                "page": "pages/19_🏡_Immobili_e_Mutui.py",
                "tab_key": None,
                "target": None,
                "keywords": "immobili mutui ammortamento francese cap rate rendita locativa ltv buy rent realestate re mortgage",
            },
            {
                "title": "⚖️ Pianificazione Successoria & Patti Famiglia",
                "page": "pages/20_⚖️_Pianificazione_Successoria.py",
                "tab_key": None,
                "target": None,
                "keywords": "successione eredita legittima asse ereditario patti famiglia holding protezione estate succession",
            },
            {
                "title": "🤖 AI Copilot & Advisor Intelligente",
                "page": "pages/21_🤖_AI_Copilot_e_Advisor.py",
                "tab_key": None,
                "target": None,
                "keywords": "ai advisor copilot health score memorandum life event podcast briefing wcopilot advisor voice",
            },
            {
                "title": "📑 Hub di Reportistica & 9 Esportazioni",
                "page": "pages/12_🎛️_Wealth_Control_Room.py",
                "tab_key": None,
                "target": None,
                "keywords": "esportazioni pdf pitchbook excel master parquet csv json reportistica reports export",
            },
        ]
    ...
    with col_w2:
        st.markdown(
            '<div style="font-size:11.5px; font-weight:700; color:#10b981; margin-bottom:6px; letter-spacing:0.5px;">💎 MNEMONICI PATRIMONIALI RAPIDI</div>',
            unsafe_allow_html=True,
        )
    ...
    with col_w3:
        st.markdown(
            '<div style="font-size:11.5px; font-weight:700; color:#10b981; margin-bottom:6px; letter-spacing:0.5px;">⌨️ SHORTCUTS WEALTH</div>',
            unsafe_allow_html=True,
        )
...
def render_workflow_stepper(current_step: int = 1):
    ...
    s1_style = (
        "border-color: #ff9900; background: rgba(255, 153, 0, 0.15); color: #ffffff;"
        if current_step >= 1
        else "color: #8b949e;"
    )
    s2_style = (
...
def render_validation_report(report: dict):
    ...
    if errors:
        st.markdown(
            '<div class="section-header" style="color: #f85149; border-color: rgba(248, 81, 73, 0.4);">🔴 Errori di Validazione Bloccanti</div>',
            unsafe_allow_html=True,
        )
        for e in errors:
            st.markdown(
    ...
    if fixes or warnings:
        ...
        fixes_badge = (
            f'<span class="executive-badge badge-green">🟢 {len(fixes)} Correzioni Automatiche</span>' if fixes else ""
        )
        warn_badge = (
            f'<span class="executive-badge badge-yellow">🟡 {len(warnings)} Avvisi di Controllo</span>'
            if warnings
            else ""
        )
        ...
        with st.expander(f"🛠️ Dettaglio Audit Data Quality ({tot_items} note di validazione)", expanded=bool(warnings)):
            ...
            if fixes:
                ...
                for f in fixes:
                    st.markdown(
                        f'<div style="background: rgba(63, 185, 80, 0.08); border-left: 3px solid #3fb950; border-radius: 6px; padding: 8px 12px; margin-bottom: 6px; font-size: 13px; color: #e6edf3;">✓ {f}</div>',
                        unsafe_allow_html=True,
                    )
            ...
            if warnings:
                ...
                for w in warnings:
                    st.markdown(
                        f'<div style="background: rgba(210, 153, 34, 0.08); border-left: 3px solid #d29922; border-radius: 6px; padding: 8px 12px; margin-bottom: 6px; font-size: 13px; color: #e6edf3;">⚠️ {w}</div>',
                        unsafe_allow_html=True,
                    )
...
def apply_plotly_theme(fig, theme_name=None, portal_mode="auto"):
    ...
    is_wealth = portal_mode == "wealth" or (
        portal_mode == "auto" and st.session_state.get("argus_portal_mode") == "🏛️ Wealth Management"
    )
    if is_wealth:
        accent = "#10b981"
    else:
        accent = (
            "#ff9900"
            if theme_name == "Midnight Obsidian"
            else ("#00f3ff" if theme_name == "Cyberpunk Neon" else "#00c853")
        )
    ...
    fig.update_layout(
        ...
        hoverlabel={"bgcolor": "#161b22", "font_size": 13, "font_family": "Outfit, sans-serif", "bordercolor": accent},
...
def render_factor_radar_chart(results: dict):
    ...
    categories = ["Market Beta", "Size SMB", "Value HML", "Volatilità", "Diversificazione DR", "Asimmetria Skew"]
    ...
    fig.add_trace(
        go.Scatterpolar(
            ...
            line={"color": "#8fa0ba", "width": 1.5, "dash": "dash"},
    ...
    fig.update_layout(
        polar={
            "radialaxis": {"visible": True, "range": [0, 100], "showticklabels": False, "gridcolor": "rgba(255,255,255,0.1)"},
            "angularaxis": {"gridcolor": "rgba(255,255,255,0.1)", "tickfont": {"size": 12, "color": "#c9d1d9"}},
...
def render_risk_heatmap(positions_df, risk_contrib=None):
    ...
    for _, r in df.iterrows():
        ...
        hovertexts.append(
            f"<b>{t}</b><br>Asset Class: {ac}<br>Controvalore: € {val:,.2f}<br>Peso Portafoglio: {w_pct:.2f}%<br>PnL Latente: {pnl:+,.2f} € ({pnl_pct:+.2f}%)"
        )
    ...
    fig = go.Figure(
        go.Treemap(
            ...
            marker={
                ...
                "cmax": max_abs_pnl,
                "colorbar": {
                    "title": {"text": "PnL Latente (€)", "font": {"size": 12, "color": "#c9d1d9"}},
                    "tickformat": "€ ,.0f",
                    "thickness": 14,
                    "len": 0.85,
    ...
    fig.update_layout(
        height=420, margin={"l": 5, "r": 5, "t": 10, "b": 10}, paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="rgba(0,0,0,0)"
    )
    return apply_plotly_theme(fig)
...
def _generate_dynamic_fallback_5point(label: str, help_text: str = None) -> str:
    ...
    is_risk = any(
        w in lbl_lower for w in ["risch", "risk", "var", "volat", "drawdown", "stress", "shock", "perdita", "downside"]
    )
    is_trading = any(
        w in lbl_lower for w in ["trade", "order", "book", "exec", "slippage", "vwap", "spread", "volume", "hhi", "win"]
    )
    ...
    is_ratio = any(
        w in lbl_lower for w in ["%", "tasso", "rate", "ratio", "percentuale", "quota", "incidenza", "rendimento"]
    )
    ...
    ) or ("costo" in lbl_lower and not any(w in lbl_lower for w in ["drag", "slippage", "burn"]))
    ...
    if is_inverted and not any(
        w in lbl_lower for w in ["valore contabile", "saldo cassa", "patrimonio", "montante", "controvalore", "carico"]
    ):
        ...
        how_to_read = "• 🟢 Valore superiore al target strategico o al benchmark di riferimento<br>• 🟡 In linea con la media storica di periodo<br>• 🔴 Valore al di sotto della soglia minima prudenziale richiesta."
    elif is_duration:
        how_to_read = "• 🟢 Orizzonte ampio e capiente (Margine di sicurezza temporale elevato)<br>• 🟡 Orizzonte intermedio da presidiare<br>• 🔴 Orizzonte compresso (Intervento prioritario richiesto)."
    elif is_currency:
        how_to_read = (
...
def render_metric_info_modal(
    metric_key: str, title: str = None, button_label: str = "ℹ️ Metodologia & Guida", use_popover: bool = False
):
    """
    ...
    render_info_modal(title=effective_title, content=content, button_label=button_label, use_popover=use_popover)
...
def metric_card(
    ...
    if delta:
        ...
        if positive is None or (not has_sign_prefix and not has_explicit_sentiment):
            delta_html = (
                f'<div style="color: #8b949e; font-size: 11.5px; font-weight: 500; margin-top: 3px;">{d_str}</div>'
            )
        else:
...
def render_status_badge(text: str, level: str = "success", pulse: bool = False, icon: Optional[str] = None) -> str:
    """
...
def render_page_header(
    title: str, subtitle: str = "", icon: str = "👁️", badge_status: Optional[str] = None, badge_level: str = "success"
):
...
def load_benchmark_returns(ticker: str, df_prices, portfolio_index) -> pd.Series:
    ...
    if (
        ...
        and isinstance(df_prices, pd.DataFrame)
...
def render_risk_free_modal(
    ...
    if risk_free_info is not None and isinstance(risk_free_info, dict) and "rate_pct" in risk_free_info:
        ...
        custom_rf_val = (
            (float(st.session_state.get("custom_rf_rate_pct", 2.75)) / 100.0)
            if st.session_state.get("rf_mode") == "Manuale"
            else None
        )
...
def render_broker_hub_modal(button_label: str = "ℹ️ Guida Export Broker", use_popover: bool = False):
    """
...
def render_garch_fhs_modal(button_label: str = "ℹ️ Metodologia GARCH(1,1) & FHS", use_popover: bool = False):
    """
    Renderizza un modale informativo istituzionale dedicato alla spiegazione
...
def render_volatility_smile_modal(
    button_label: str = "ℹ️ Metodologia Volatility Smile & Skew", use_popover: bool = False
):
    """
    Renderizza un modale informativo istituzionale dedicato alla spiegazione
...
def render_crypto_tax_modal(button_label: str = "ℹ️ Normativa Fiscale Cripto (L. 197/2022)", use_popover: bool = False):
    """
...
def render_fama_french_modal(button_label: str = "ℹ️ Teoria Fama-French 5-Factor & Momentum", use_popover: bool = False):
    """
...
def render_sec_rag_modal(button_label: str = "ℹ️ Guida al Motore SEC RAG & Form 10-K", use_popover: bool = False):
    """
...
def render_duckdb_modal(button_label: str = "ℹ️ Guida al Motore OLAP DuckDB & Parquet", use_popover: bool = False):
    """
...
def render_altman_zscore_modal(button_label: str = "🧮 Guida & Formula Altman Z-Score", use_popover: bool = False):
    """
    ...
    render_info_modal(
        title="🛡️ Guida all'Altman Z-Score (1968)", content=content, button_label=button_label, use_popover=use_popover
    )
...
def render_control_room_hero():
    ...
    port_label, has_port = get_display_portfolio_name()
    port_html = (
        f'<b style="color:#ffffff;">{port_label}</b>'
        if has_port
        else f'<span style="color:#e3b341; font-style:italic;">{port_label}</span>'
    )
...
def render_wealth_profile_picker(engine, profile_map: dict, key_prefix: str = "wpp"):
    ...
    from core.wealth.wealth_db import create_wealth_portfolio, get_wealth_portfolios
    ...
    with new_col:
        ...
        with st.popover("➕ Crea Profilo", use_container_width=True):
            np_name = st.text_input(
                "Nome Profilo *", placeholder="es. Famiglia, Holding...", key=f"{key_prefix}_new_name"
            )
            np_owner = st.text_input(
                "Proprietario / Titolare", placeholder="es. Famiglia Rossi", key=f"{key_prefix}_new_owner"
            )
            if st.button(
                "Conferma Creazione", type="primary", use_container_width=True, key=f"{key_prefix}_btn_confirm"
            ):
                if np_name.strip():
                    try:
                        n_pid = create_wealth_portfolio(
                            engine,
                            np_name.strip(),
...
def ensure_risk_bundle_loaded(
    default_preset: str = "🏦 Bilanciato Istituzionale (60/40 Equity/Bond)", require_loaded: bool = False
) -> tuple:
    """
    ...
    has_real = (
        ...
        and bool(
            results.get("positions") is not None
            and not results.get("positions").empty
            and not results.get("is_sandbox", False)
        )
    )
    ...
    if not has_real:
        if (
            results is None
            or not results.get("is_sandbox", False)
            or results.get("positions") is None
            or results.get("positions").empty
        ):
            ...
            results = compute_sandbox_risk_bundle(
                tickers=tks, sandbox_name=sel_preset, risk_free_rate=rf_val, base_currency=base_curr
            )
    ...
    if results is not None and isinstance(results, dict):
        ...
        if pos is not None and isinstance(pos, pd.DataFrame) and not pos.empty:
            df_returns = (
                results.get("returns")
                if isinstance(results.get("returns"), pd.DataFrame)
                else results.get("df_returns")
            )
            bm_returns = (
                        ...
                        if "crypto" in ac or any(c in tk.lower() for c in ["btc", "eth", "sol", "xrp", "ada", "fdusd"]):
                            b_val = (
                                ...
                                if "BTC" in tk
                                    ...
                                    1.95 if "ETH" in tk else (2.10 if "SOL" in tk else (0.0 if "FDUSD" in tk else 1.80))
                                )
                            )
                        elif "etf" in ac:
            ...
            if not valid_pos.empty:
                ...
                if w_tot > 0:
                    ...
                    if (
                        curr_port_b is None
                        or abs(float(curr_port_b) - 1.0) < 1e-4
                        or abs(float(curr_port_b) - weighted_b) > 0.001
                    ):
...
def render_sandbox_banner(page_key: str = "gen"):
    ...
    cand_tk_extra = (
        cand_handoff.get("ticker") if (isinstance(cand_handoff, dict) and cand_handoff.get("ticker")) else None
    )
    ...
    with st.container():
        ...
        with col_sb2:
            ...
            try:
                st.page_link(
                    "pages/1_📈_Dashboard_Generale.py",
                    label="📥 Carica Portafoglio Reale",
                    icon="💼",
                    help="Carica un CSV o connettiti a MySQL",
                )
            except Exception:
                try:
                    st.page_link(
        ...
        if cand_tk_extra and cand_tk_extra not in selected_tickers:
            ...
            st.markdown(
                f"<div style='color:#3fb950; font-size:12px; font-weight:700; margin-top: -6px; margin-bottom: 8px;'>🧪 + Asset candidato <b>{cand_tk_extra}</b> ({cand_handoff.get('weight_pct', 5)}%) incluso automaticamente dallo Screener Pre-Trade</div>",
                unsafe_allow_html=True,
            )
...
def render_duckdb_olap_cube_widget(df_positions: pd.DataFrame, key_prefix: str = "p1"):
    ...
    df_positions = df_positions[
        (df_positions.get("qty_net", 1) > 1e-6) & (df_positions.get("current_value", 1) > 1e-6)
    ].copy()
    ...
    df_assets = (
        df_cube[df_cube["livello_aggregazione"] == "Macro Asset Class"]
        if "livello_aggregazione" in df_cube.columns
        else df_cube[df_cube["sector"] == "--- TUTTI I SETTORI ---"]
    )
    top_asset_name = "N/A"
    top_asset_val = 0.0
    top_asset_pct = 0.0
    total_port_val = (
        df_cube[df_cube["livello_aggregazione"] == "Portafoglio Totale"]["controvalore_totale"].sum()
        if "livello_aggregazione" in df_cube.columns
        else df_cube["controvalore_totale"].max()
    )
    ...
    df_sectors = (
        df_cube[df_cube["livello_aggregazione"] == "Breakdown Settoriale"]
        if "livello_aggregazione" in df_cube.columns
        else df_cube[(df_cube["currency"] == "ALL") & (df_cube["sector"] != "--- TUTTI I SETTORI ---")]
    )
    top_sec_name = "N/A"
    top_sec_ret = 0.0
    top_sec_pnl = 0.0
    ...
    curr_col = (
        "asset_currency"
        if ("asset_currency" in df_positions.columns and df_positions["asset_currency"].nunique() > 1)
        else ("currency" if "currency" in df_positions.columns else None)
    )
    df_curr = (
        df_positions.groupby(curr_col)["current_value"].sum().reset_index().rename(columns={curr_col: "currency"})
        if curr_col and "current_value" in df_positions.columns
        else pd.DataFrame()
    )
    top_curr_name = "EUR"
    top_curr_pct = 100.0
    ...
    tab_matrice, tab_treemap, tab_ranking = st.tabs(
        ["🏛️ Matrice Gerarchica & Subtotali", "🌐 Treemap Gerarchico Multi-Livello", "🏆 Top Performers per Settore"]
    )
    ...
    with tab_matrice:
        ...
        if sel_gran == "🎯 Breakdown Settoriale":
            df_view = (
                df_cube[df_cube["livello_aggregazione"] == "Breakdown Settoriale"].copy()
                if "livello_aggregazione" in df_cube.columns
                else df_cube.copy()
            )
            display_cols = [
                ...
                "controvalore_totale",
                "pnl_latente_totale",
                "rendimento_medio_pct",
            ]
        elif sel_gran == "🏛️ Macro Asset Class":
            df_view = (
                df_cube[df_cube["livello_aggregazione"] == "Macro Asset Class"].copy()
                if "livello_aggregazione" in df_cube.columns
                else df_cube.copy()
            )
            display_cols = [
            ...
            df_view = (
                df_cube[df_cube["livello_aggregazione"] == "Dettaglio Valuta 3D"].copy()
                if "livello_aggregazione" in df_cube.columns
                else df_cube.copy()
            )
            display_cols = [
        ...
        st.dataframe(df_view, column_config=cube_cfg, use_container_width=True, hide_index=True)
    ...
    with tab_treemap:
        ...
        df_tree["gain_pct"] = df_tree.apply(
            lambda r: (r["pnl_unrealized"] / r["cost_basis"] * 100.0) if r["cost_basis"] > 0 else 0.0, axis=1
        ).round(2)
        ...
        if not df_tree.empty:
            ...
            with col_t1:
                st.markdown(
                    "<div style='color: #8b949e; font-size: 13px; margin-top: 6px;'>🗺️ <b>Mappa Gerarchica di Allocazione</b> (Dimensione = Controvalore €, Colore = Rendimento %)</div>",
                    unsafe_allow_html=True,
                )
            with col_t2:
                chart_type = (
            ...
            color_scale = [[0.0, "#cf222e"], [0.5, "#21262d"], [1.0, "#2ea043"]]
            ...
            fig.update_layout(
                margin={"t": 15, "l": 10, "r": 10, "b": 10},
                paper_bgcolor="rgba(0,0,0,0)",
                plot_bgcolor="rgba(0,0,0,0)",
                font={"color": "#e6edf3"},
                coloraxis_colorbar={"title": "Rend. %", "ticksuffix": "%", "len": 0.75, "thickness": 12},
            )
            if hasattr(fig.data[0], "marker") and getattr(fig.data[0].marker, "colors", None) is not None:
                ...
                fig.update_traces(hovertemplate="<b>%{label}</b><br>Controvalore: €%{value:,.2f}<extra></extra>")
    ...
    with tab_ranking:
        if rank_res.get("success") and not rank_res["df"].empty:
            ...
            with col_r1:
                st.caption(
                    f"⚡ Calcolo Window Function in **{rank_res['latency_ms']:.2f} ms** (DuckDB `QUALIFY DENSE_RANK() ≤ 3` per Settore)"
                )
            with col_r2:
                render_export_toolbar(
                    df_rank,
            ...
            st.dataframe(df_rank, column_config=rank_cfg, use_container_width=True, hide_index=True)
        else:
...
def ensure_wealth_bundle_loaded(engine, default_profile_name: str = "Marco Rossi (Family Office)") -> tuple:
    ...
    if df_prof.empty:
        pid = create_wealth_portfolio(
            engine, name=default_profile_name, owner="Family Office Principal", base_currency="EUR"
        )
...
def ensure_portal_context(module: str = "risk") -> dict:
    ...
    raw_db = (
        ...
        or st.session_state.get("wealth_db_name")
        or st.session_state.get("risk_db_name")
        or "wealth"
    )
    db_name = raw_db
    ...
    if is_wealth:
        ...
        if df_prof.empty:
            ...
            if df_prof.empty:
                pid = create_wealth_portfolio(
                    engine, name="Marco Rossi (Family Office)", owner="Family Office Principal", base_currency="EUR"
                )
                st.session_state["wealth_active_portfolio_id"] = None
                df_prof = get_wealth_portfolios(engine)
...
def render_omni_command_bar(portal: str = "auto", context_name: Optional[str] = None, key_suffix: str = "core"):
    """
    ...
    mode_bg = (
        "rgba(227, 179, 65, 0.10)" if offline else f"rgba({('16, 185, 129' if is_wealth else '255, 153, 0')}, 0.12)"
    )
    mode_border = (
...
def generate_svg_sparkline(
    data: List[Union[float, int]], width: int = 80, height: int = 24, color: Optional[str] = None, show_dot: bool = True
) -> str:
    """
...
def render_data_table(
    ...
    if table_title or download_filename:
        ...
        with col_exp:
            render_export_toolbar(
                df=df, file_prefix=prefix, key_suffix=prefix, table_title=table_title, show_row_count=False
            )
    ...
    curr_symbol = (
        ...
        if base_curr == "EUR"
            ...
            "$" if base_curr == "USD" else ("£" if base_curr == "GBP" else "CHF" if base_curr == "CHF" else base_curr)
        )
    )
    ...
    if pct_cols:
        for c in pct_cols:
            if c in df.columns:
                col_config[c] = st.column_config.NumberColumn(c, format="%.2f%%", help="Valore percentuale")
    ...
    st.dataframe(df, column_config=col_config, hide_index=hide_index, height=height, use_container_width=True)
