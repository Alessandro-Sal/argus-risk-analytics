...
def generate_ai_voice_executive_briefing(
    engine: Any, portfolio_id: int = 1, client_name: str = "Family Office Master", speaker_mode: str = "dialogue"
) -> Dict[str, Any]:
    """
    ...
    from core.wealth.wealth_engine import compute_ai_wealth_diagnostics, compute_consolidated_net_worth
