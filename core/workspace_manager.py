...
PAGE_ROUTE_MAP = {
    ...
    "2_Analisi_Rischio": "pages/2_🔴_Analisi_Rischio.py",
    "3_Modelli_Quantitativi": "pages/3_🔬_Modelli_Quantitativi.py",
    "4_Posizioni_e_Dettagli": "pages/4_📋_Posizioni_e_Dettagli.py",
    "5_Valutazione_Aziendale": "pages/5_🏛️_Valutazione_Aziendale.py",
    "6_Stress_Testing": "pages/6_🌪️_Stress_Testing.py",
    "7_Analisi_Temporale": "pages/7_📊_Analisi_Temporale.py",
    "8_Analisi_Tecnica": "pages/8_📈_Analisi_Tecnica.py",
    "9_Screener_Opportunita": "pages/9_🔍_Screener_Opportunita.py",
}
