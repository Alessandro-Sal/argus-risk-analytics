...
from core.ui_utils import inject_custom_css, metric_card, fmt_pct, glossary_modal, render_executive_badges, section, render_formula_popover, apply_plotly_theme
            ...
            if not frontier.empty:
                ...
                if mv:
                    fig_f.add_trace(go.Scatter(
                        ...
                        textfont=dict(color="#58a6ff", size=13, family="Arial Black")
                    ))
