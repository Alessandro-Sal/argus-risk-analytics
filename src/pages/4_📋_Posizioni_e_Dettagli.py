...
<div><b>🔍 Come leggerlo:</b> Utile per analizzare gli errori di timing o le tesi d'investimento invalidate.</div>
        ...
        # ── 2. GRAFICI ANALITICI COCKPIT (SIDE-BY-SIDE COMPATTO) ──────
        col_g_chart1, col_g_chart2 = st.columns(2)
        ...
        with col_g_chart1:
            ...
            if not df_assets_closed.empty:
                ...
                fig_bar_pnl.update_layout(
                    template="plotly_dark", height=cockpit_height,
                    xaxis=dict(
        ...
        with col_g_chart2:
            st.markdown("##### ⏱️ Rendimento vs Tempo di Detenzione")
