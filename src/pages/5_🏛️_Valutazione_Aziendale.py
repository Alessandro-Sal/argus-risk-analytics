...
def get_verdict(row):
    ...
    # Se il PEG è disastroso, penalizziamo
...
# Selezioniamo solo le righe con dati di valutazione
...
# ---- SEZIONE 1: Riepilogo Valutazioni ----
...
# ---- SEZIONE 2: Dettaglio Valutazione ----
...
<ul style="margin-top:0; padding-left:20px;">
    <li style="margin-bottom:12px;"><b>Target Price (Prezzo Obiettivo):</b>
        <ul style="margin-top:4px;">
            <li><b><b>Cosa significa:</b></b> È il prezzo futuro a cui gli analisti finanziari ritengono che l'azione debba tendere nei successivi 12 mesi, basandosi sui bilanci e sulle proiezioni di crescita.</li>
            <li><b><b>A cosa serve:</b></b> È la bussola del mercato. Ti permette di capire se i grandi player istituzionali vedono l'asset in salita (opportunità) o in stallo.</li>
            <li><b><b>Come si calcola:</b></b> Media aritmetica di tutti i singoli Target Price emessi dalle maggiori banche d'affari.</li>
        </ul>
    </li>
    <li style="margin-bottom:12px;"><b>Upside / Downside %:</b>
        <ul style="margin-top:4px;">
            <li><b><b>Cosa significa:</b></b> È il potenziale di guadagno (Upside) o perdita (Downside) necessario affinché il prezzo attuale raggiunga il Target Price.</li>
            <li><b><b>A cosa serve:</b></b> Misura la "distanza percentuale dal Fair Value". Più l'Upside è alto, più l'asset è considerato sottovalutato. Se è negativo, l'azione è considerata troppo cara.</li>
            <li><b><b>Come si calcola:</b></b> <code>(Target Price / Prezzo Attuale) - 1</code>.</li>
        </ul>
    </li>
    <li><b>PEG Ratio (Price/Earnings-to-Growth):</b>
        <ul style="margin-top:4px;">
            <li><b><b>Cosa significa:</b></b> È l'evoluzione del famoso P/E Ratio. Mette in relazione il prezzo pagato per gli utili con la velocità a cui questi utili stanno crescendo.</li>
            <li><b><b>A cosa serve:</b></b> È il Santo Graal del <i>Value Investing</i>. Un P/E di 30 può sembrare altissimo, ma se l'azienda cresce del 40% all'anno, il PEG è &lt; 1 (quindi l'azione è economica).
                <ul>
                    <li><b>PEG &lt; 1.0</b>: Azione estremamente sottovalutata.</li>
                    <li><b>PEG ~ 1.0 - 1.5</b>: Valutazione equa (Fair Value).</li>
                    <li><b>PEG &gt; 2.0</b>: Azione costosissima, in probabile "bolla" speculativa.</li>
                </ul>
            </li>
            <li><b><b>Come si calcola:</b></b> <code>P/E Ratio / Tasso stimato di crescita annua degli utili</code>.</li>
        </ul>
    </li>
</ul>
""", button_label="📖 Glossario Metriche")
    
    # Grafico a torta dei verdetti
...
if not df_upside.empty:
    ...
    st.markdown("**Distanza dal Fair Value degli Analisti (%)**")
    st.plotly_chart(fig_bar, use_container_width=True)

# ── Private Equity & Private Markets Simulator (J-Curve & Waterfall) ─────────────
st.divider()
...
Esprime il moltiplicatore totale di valore generato dal fondo di Private Equity rispetto al capitale richiamato (Capital Calls). Es: 2.50x significa che per ogni Euro investito, il fondo ne ha generati 2.50.</p>
