...
from core.ui_utils import apply_plotly_theme, inject_custom_css, render_command_bar
    ...
    with col_chart_a:
        ...
        if not df_pos_a.empty:
            fig_pie_a = px.pie(
                ...
                title="Ripartizione per Asset Class A", hole=0.65,
            ...
            fig_pie_a.update_layout(template="plotly_dark", paper_bgcolor="rgba(0,0,0,0)", height=300)
    ...
    with col_chart_b:
        ...
        if not df_pos_b.empty:
            fig_pie_b = px.pie(
                ...
                title="Ripartizione per Asset Class B", hole=0.65,
                color_discrete_sequence=["#58a6ff", "#00e676", "#bc8cff", "#ff9900", "#f85149"]
            )
            ...
            fig_pie_b.update_layout(template="plotly_dark", paper_bgcolor="rgba(0,0,0,0)", height=300)
